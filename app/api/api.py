...
from app.crud.task import TaskCreate, TaskUpdate , create_task, get_tasks, get_task, update_task, delete_task
...
def update_ex_task(task_id: UUID, task_update: TaskUpdate, db: Session = Depends(get_db)):
    """Обновить задачу"""
...
def delete_ex_task(task_id: UUID, db: Session = Depends(get_db)):
    """Удалить задачу"""
